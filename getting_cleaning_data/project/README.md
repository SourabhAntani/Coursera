...
7. Creates a new data table by extracting the mean and standard deviation columns from the dataset. This is achieved by looking for certain keywords in the column names.
...
### Description of variables (Codebook)
